...
// @resource home 		http://www.c-dev.ch/geocaching/greasemonkey/geomaps/1.2/images/home.png
// @resource float 		http://www.c-dev.ch/geocaching/greasemonkey/geomaps/1.2/images/float.png
// @resource pinned 	http://www.c-dev.ch/geocaching/greasemonkey/geomaps/1.2/images/pinned.png
// @resource dist 		http://www.c-dev.ch/geocaching/greasemonkey/geomaps/1.2/images/dist.png
// @resource proj 		http://www.c-dev.ch/geocaching/greasemonkey/geomaps/1.2/images/proj.png
// @resource close 		http://www.c-dev.ch/geocaching/greasemonkey/geomaps/1.2/images/close.png
// @resource setting 	http://www.c-dev.ch/geocaching/greasemonkey/geomaps/1.2/images/setting.png
// @resource outdooractivemap 	http://www.c-dev.ch/geocaching/greasemonkey/geomaps/1.2/images/outdooractivemap.png

// ==/UserScript==


/*****************************************************************************
 * Copyright (C) 2014 neisgei / c-dev.ch
 *
...
var versionsNummer = '1.2.5';
GM_setValue('SUC_current_version', 10205);
...
function InsertCoordsPopups() {
    ...
    for (var i = 0; i < n.length; ++i) {
        try {
            ...
            for (var ii = 0; ii < validCoordinates.length; ++ii) {
                ...
                // InsertPopUp(popIndex, validCoordinates[indexIi]);
                allCoords.push(validCoordinates[ii]);
                popIndex++;
            }
    ...
    for (var cordsIndex = 0; cordsIndex < allCoords.length; cordsIndex++) {
        // console.log(allCoords[cordsIndex]);
        InsertPopUp(cordsIndex, allCoords[cordsIndex]);
    }
